...
for train_index, test_index in CV.split(X,y):
    ...
    opt_val_err, opt_lambda, mean_w_vs_lambda, train_err_vs_lambda, test_err_vs_lambda = new_rlr_validate(X_train, y_train, lambdas, internal_CV , internal_cross_validation)
